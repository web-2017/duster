                    ...
                    <div className={`col col-lg-8 col-12 ${props.blRight}`}>
                        <div className="blog-content">
                            <div className="post format-standard-image">
                                ...
                                <p>Above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame. It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered the whole of her lower </p>
                                ...
                                <h3>Cranky old comics genius. But here's the thing — given the way Hollywood has treated his work</h3>
                                <p>Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. </p>
                                <blockquote>
                                    Nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh.
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Tags: </span>
                                    <ul>
                                        <li><Link to="/blog-single/Our-expert-service-provider-make-your-home-pest">House cleaning</Link></li>
                                        <li><Link to="/blog-single/Our-expert-service-provider-make-your-home-pest">Carpet cleaning</Link></li>
                                    </ul>
                                </div>
                                <div className="share">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link to="/blog-single/Our-expert-service-provider-make-your-home-pest"><i className="ti-facebook"></i></Link></li>
                                        <li><Link to="/blog-single/Our-expert-service-provider-make-your-home-pest"><i className="ti-twitter-alt"></i></Link></li>
                                        <li><Link to="/blog-single/Our-expert-service-provider-make-your-home-pest"><i className="ti-linkedin"></i></Link></li>
                                        <li><Link to="/blog-single/Our-expert-service-provider-make-your-home-pest"><i className="ti-instagram"></i></Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="more-posts">
                                <div className="previous-post">
                                    <Link to="/blog-single/Consulting-Success-is-the-most-comprehensive-learning">
                                        ...
                                        <span className="post-name">Sed consequat, leo eget bibendum sodales, augue velit cursus nunc</span>
                                    </Link>
                                </div>
                                <div className="next-post">
                                    <Link to="/blog-single/Consulting-Success-is-the-most-comprehensive-learning">
                                        <span className="post-control-link">Next Post</span>
                                        <span className="post-name"> Sed fringilla mauris sit amet nibh donec sodales sagittis magna.</span>
                                    </Link>
                                </div>
                            </div>
