        ...
        <div className="row">
          <div className="col col-lg-6 col-12">
            ...
            <div className="details">
              ...
              <ul>
                <li>
                  <i className="ti-check-box"></i>Fitted out with a fur hat
                </li>
                <li>
                  <i className="ti-check-box"></i>Showed a lady fitted our with
                  far.
                </li>
                <li>
                  <i className="ti-check-box"></i>Hourse cleansing
                </li>
              </ul>
              <h4>
                Illustrated magazine and housed in a nice, gilded frame. It
                showed a lady fitted out with a fur hat and
              </h4>
