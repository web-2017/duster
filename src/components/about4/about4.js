...
import abimg from "../../assets/about/ab2.png";
            ...
            <div className="col-xl-5 col-lg-6 col-md-12 col-12">
              <div className="wpo-about-text">
                ...
                <p>
                  ...
                  typesetting’s the industrey's standard dummy text ever since
                  the 1500 when printed galley of type and scrambled type
                  specimen book.
                </p>
                <div className="text-sub-wrap">
                  <div className="text-sub-item">
                    ...
                    <h5>
                      Perfect solution of business and financial planning.
                    </h5>
                  </div>
                </div>
                <Link
