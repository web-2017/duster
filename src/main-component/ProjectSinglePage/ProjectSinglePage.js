...
import psImg from '../../images/latest-projects/img-6.jpg'
                                ...
                                <div className="content-area">
                                    <div className="project clearfix">
                                        <div className="project-info">
                                            <h3>Information</h3>
                                            <ul>
                                                <li><span>Client:</span> Jhon Trait</li>
                                                <li><span>Location:</span> City, Austria</li>
                                                <li><span>Date:</span> Aug 25, 2019</li>
                                                <li><span>Catetory:</span> Office, Window</li>
                                                <li><span>Time:</span> 1 Month</li>
                                                <li><span>Tags:</span> Cleaning, Services </li>
                                            </ul>
                                        </div>
                                        <div className="project-details">
                                            <h2>{projectDetails.title} Cleaning project in Austria</h2>
