            ...
            <div className="col col-lg-8 col-12">
              <div className="team-single-content">
                    ...
                    <div className="info">
                      ...
                      <ul>
                        <li>
                          ...
                          <span>Phone: </span>654-54851-5447
                        </li>
                        <li>
                          <i className="ti-email"></i>
                          <span>Email: </span>necterbuddy@hotmail.com
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          <span>Address: </span>45 big fella street, sweet home,
                          Bela
                        </li>
                      </ul>
                    </div>
                ...
                <div className="team-details">
                  ...
                  <h2>Experience</h2>
                  <p>
                    Above it there hung a picture that he had recently cut out
                    of an illustrated magazine and housed in a nice, gilded
                    frame. It showed a lady fitted out with a fur hat and fur
