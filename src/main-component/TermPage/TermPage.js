...
import FAQ from "./faq";
import tImg1 from "../../assets/terms/terms.jpg";
import tImg2 from "../../assets/terms/1.jpg";
import tImg3 from "../../assets/terms/2.jpg";
...
const TermPage = (props) => {
  return (
    <Fragment>
      <Navbar />
      <PageTitle
        pageTitle={"Terms & Coditions"}
        pagesub={"Terms & Coditions"}
      />
              ...
              <div className="wpo-terms-wrap">
                ...
                <div className="wpo-terms-text">
                  ...
                  <p>
                    ...
                    overlook creating and adding a website terms and conditions
                  ...
                  <p>
                    Even a short terms and conditions agreement should include
                    several key clauses to safeguard your business. For example,
                    if you’re selling online and incorrectly price an item, your
                    terms and conditions are what will enable you to cancel the
                    order.
                  </p>
