                    ...
                    <div className="row">
                        <div className="col col-lg-9 order-lg-2 order-1">
                            <div className="service-single-content">
                                ...
                                <blockquote>
                                    <p>Fragment collings mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc</p>
                                ...
                                <div className="benefit clearfix">
                                    ...
                                    <div className="details">
                                        ...
                                        <ul>
                                            <li><span>1</span> Tellus eget condimentum rhoncus, sem quam</li>
                                            <li><span>2</span> Get condimentum rhoncus, sem quam</li>
                                            <li><span>3</span> Condimentum rhoncus, sem quam</li>
                                        </ul>
                                        <p>Tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibussem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar</p>
                                    </div>
                                </div>
                                <h3>Research</h3>
                                <p>Tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus</p>
                                <ServiceTab />
                        ...
                        <div className="col col-lg-3 order-lg-1 order-2">
                            <div className="service-sidebar">
                                ...
                                <div className="widget download-widget">
                                    <ul>
                                        <li><Link onClick={ClickHandler} to="/services"><i className="ti-zip"></i>Company presentation</Link></li>
                                    </ul>
                                </div>
